...
public class ExtentManager extends Basepage {
	...
	public static ExtentReports setupExtentReport(String testName) {
		...
		ExtentSparkReporter spark= new ExtentSparkReporter(System.getProperty("user.dir")+ "/target//"+ extentReportprefix_name(testName)+".html");
		extentReport.attachReporter(spark);
		
		extentReport.setSystemInfo("tester","Sai krishna");
